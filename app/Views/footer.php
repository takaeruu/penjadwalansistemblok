<script src="<?= base_url('js/jquery.min.js')?>"></script>
    <script src="<?= base_url('vendorjs/popper.min.js')?>"></script>
    <script src="<?= base_url('vendorjs/moment.min.js')?>"></script>
    <script src="<?= base_url('vendorjs/bootstrap.min.js')?>"></script>
    <script src="<?= base_url('vendorjs/simplebar.min.js')?>"></script>
